<?php include('inc/header.inc.php');?>
  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="about">
      <div class="w-100">
        <h1 class="mb-0">Baptiste
          <span class="text-primary">Marie</span>
        </h1>
        <div class="subheading mb-5">58 boulevard de la gare 95350 saint brice sous foret
          <a href="mailto:name@email.com">baptiste.marie@ynov.com</a>
        </div>
        <p class="lead mb-5">étudiant a ynov paris campus en première année</p>
